...
//        private long regon = Long.parseLong(p.getProperty("REGON")); // nie istnieje w wersji JPK(3)

        private final int IDENTYFIKATOR_PODMIOTU_OFFSET = Integer.parseInt(PropertyReader.getInstance().plikWyjsciowyProp.getProperty("v3identyfikatorPodmiotuOffset"));
