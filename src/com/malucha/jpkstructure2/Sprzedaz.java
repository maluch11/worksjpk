...
public class Sprzedaz {
    ...
    private final int SPRZEDAZ_OFFSET = Integer.parseInt(PropertyReader.getInstance().plikWyjsciowyProp.getProperty("sprzedazOffset"));
    ...
    public Sprzedaz(int lpSprzedazy, long nrKontrahenta, String nazwaKontrahenta, String adreskontrahenta, String dowodSprzedazy, LocalDate dataWystawienia, LocalDate dataSprzedazy, BigDecimal k_17, BigDecimal k_18, BigDecimal k_19, BigDecimal k_20) {
