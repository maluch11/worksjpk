...
//    private BigDecimal netto2_8;
    ...
    private BigDecimal nettoOdwrObciaz; //20181201 - added to process 'odwrotne obciazenie' invoices issued for client/contractor
    private BigDecimal bruttoOdwrObciaz; //20181201 - added to process 'odwrotne obciazenie' invoices issued for client/contractor
    ...
    **/
    ...
    public WorksSprzedaz(int numer, String nabywca, String nabywcaAdres, long nip, BigDecimal netto23Sum,
                         ...
                         String korekta,
                         BigDecimal nettoOdwrObciaz,
                         BigDecimal bruttoOdwrObciaz) {
        this.numer = numer;
        ...
        this.nettoOdwrObciaz  = nettoOdwrObciaz; //20181201 - added to process 'odwrotne obciazenie' invoices issued for client/contractor
        this.bruttoOdwrObciaz = bruttoOdwrObciaz; //20181201 - added to process 'odwrotne obciazenie' invoices issued for client/contractor
    }
    ...
    public BigDecimal getNettoOdwrObciaz() {
        return nettoOdwrObciaz;
    }

    public void setNettoOdwrObciaz(BigDecimal nettoOdwrObciaz) {
        this.nettoOdwrObciaz = nettoOdwrObciaz;
    }

    public BigDecimal getBruttoOdwrObciaz() {
        return bruttoOdwrObciaz;
    }

    public void setBruttoOdwrObciaz(BigDecimal bruttoOdwrObciaz) {
        this.bruttoOdwrObciaz = bruttoOdwrObciaz;
    }
}
